import { Disposable, HasElement, LyricLine, LyricWord } from "../interfaces.d.ts";
import { Spring, SpringParams } from "../utils/spring.d.ts";
import { BottomLineEl } from "./bottom-line.d.ts";
import { InterludeDots } from "./dom/interlude-dots.d.ts";
/**
 * 歌词播放器的基类，已经包含了有关歌词操作和排版的功能，子类需要为其实现对应的显示展示操作
 */
export declare abstract class LyricPlayerBase
  extends EventTarget
