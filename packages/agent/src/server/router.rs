use crate::constants::AGENT_PROTOCOL_VERSION;
use crate::server::models::{
    AgentServiceStatus, CreateRunRequest, CreateThreadRequest, HealthResponse, ProviderConfigInput,
    SetThreadConfigRequest,
};
use crate::server::service::AgentServerState;
use crate::utils::{api_error, internal_error};
use axum::body::Body;
