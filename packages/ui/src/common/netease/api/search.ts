...
export default class _NeteaseSearchAPI {
   ...
   * */
  static search<T extends keyof NeteaseAPI.NeteaseSearchResultMap = any>(
    props: {
  ...
  /** 热搜列表(详细) */
  static hotListDetail(signal?: AbortSignal) {
   ...
   * */
  static suggest(keywords: string, signal?: AbortSignal) {
