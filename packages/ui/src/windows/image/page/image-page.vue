...
<script setup lang="ts" name="ImagePage">
  import TopControlPure from "@mahiru/ui/common/components/top/control.vue";
  import Drag from "@mahiru/ui/common/components/drag/drag.vue";
  import ImageViewer from "@mahiru/ui/common/components/image/image-viewer.vue";
  import { ElectronServicesWindow } from "@mahiru/ui/common/source/electron/services";
  import { useAppLoadedVue } from "@mahiru/ui/common/hooks/use-app-loaded-vue";
