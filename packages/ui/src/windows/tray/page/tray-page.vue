...
<script setup lang="ts" name="Tray">
  import TrayItem from "@mahiru/ui/windows/tray/page/tray-item.vue";
  import TrayPlayer from "@mahiru/ui/windows/tray/page/tray-player.vue";
  import TrayDivider from "@mahiru/ui/windows/tray/page/tray-divider.vue";
  import {
    ElectronServicesBus,
  ...
  import { useThemeInjectFromBus } from "@mahiru/ui/common/hooks/use-theme-inject-from-bus-vue";
