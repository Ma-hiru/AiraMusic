...
import { useWindowTitle } from "@mahiru/ui/common/hooks/use-window-title";
import {
  type ShortcutConfig,
  useKeyboardShortcut
} from "@mahiru/ui/common/hooks/use-keyboard-shortcut";
import { useMediaSession } from "@mahiru/ui/windows/main/hooks/use-media-session";
import { useSpectrumWorker } from "@mahiru/ui/windows/main/hooks/use-spectrum-worker";
