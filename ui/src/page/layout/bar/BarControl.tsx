...
const BarControl: FC<object> = () => {
  ...
  return (
    <div className="flex justify-center items-center gap-6">
      <SkipBack className="hover:scale-90 active:scale-80 cursor-pointer ease-in-out transition-all duration-300 size-5" fill={"#171b20"} onClick={lastTrack} />
      ...
      <SkipForward className="hover:scale-90 active:scale-80 cursor-pointer ease-in-out transition-all duration-300 size-5" fill={"#171b20"} onClick={nextTrack} />
    </div>
  );
};
