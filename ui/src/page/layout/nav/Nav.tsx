...
const Nav: FC<object> = () => {
  ...
  return (
    <div
      className={cx(
        "absolute grid grid-cols-1 grid-rows-[auto_auto_auto_1fr] left-0 top-0 bottom-0 pb-18 px-4 backdrop-blur-lg z-10 ease-in-out duration-300 transition-all border-r border-r-gray-500/10",
