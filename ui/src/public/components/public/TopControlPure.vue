<template>
  <NoDrag class="flex flex-row gap-4 select-none relative z-50">
    <AppWindowIcon v-if="isDev" :color="props.color" class="size-5 control-button" @click="currentWindow.devTools()" />
    <Minus v-if="props.mini" :color="props.color" class="size-5 control-button" @click="currentWindow.minimize()" />
    <Square v-if="props.maximizable" v-show="currentWindow.isMax" :color="props.color" class="size-5 control-button"
      @click="currentWindow.unmaximize()" />
    <SquareMinus v-if="props.maximizable" v-show="!currentWindow.isMax" :color="props.color"
      class="size-5 control-button" @click="currentWindow.maximize()" />
