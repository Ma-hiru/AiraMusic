...
export async function getMP3(id: string | number, quality?: NeteaseQualityLevels) {
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:getMP3", err);
  }
}
...
export async function getMP3New(id: string | number, level: NeteaseMusicLevel, unblock = false) {
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:getMP3New", err);
  }
}
...
export async function getTrackDetail(ids: string | number): Promise<NeteaseTrackDetailResponse> {
  ...
  try {
    ...
    throw Errs.CacheStoreErr.create("ui/api/track.ts:getTrackDetail", err);
  }
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:getTrackDetail", err);
  }
}
...
export async function likeATrack(params: {
  ...
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:likeATrack", err);
  }
}
...
async function requestScrobble(params: {
  ...
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:scrobble", err);
  }
}
...
export async function getTrackChorus(id: number) {
  ...
  try {
    ...
    throw Errs.CacheStoreErr.create("track.ts:getTrackChorus", err);
  }
  try {
    ...
    throw Errs.NCMServerErr.create("ui/api/track.ts:getTrackChorus", err);
  }
}
