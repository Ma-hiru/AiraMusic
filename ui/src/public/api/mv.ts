...
export default class _NeteaseMVAPI {
  /**
   * 获取 mv 数据
   ...
   */
  static detail(mvid: number) {
    return apiRequest<{ mvid: number; timestamp: number }, NeteaseAPI.NeteaseAPIResponse>({
      url: "/mv/detail",
      method: "get",
      params: {
        mvid,
   ...
   * @param mvid mv id
   */
  static similar(mvid: number) {
    return apiRequest<{ mvid: number }, NeteaseAPI.NeteaseAPIResponse>({
      url: "/simi/mv",
      method: "get",
      params: { mvid }
    });
  ...
  static star(params: {
    ...
    return apiRequest<typeof params & { timestamp: number }, NeteaseAPI.NeteaseAPIResponse>({
      url: "/mv/sub",
      method: "post",
      params: {
        ...params,
