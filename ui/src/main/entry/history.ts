...
@AddPlayerStore
@AddLocalStore
export class PlayerHistoryClass {
  private readonly maxSize;
  private outerUpdater: Set<NormalFunc> = new Set();
  private history: HistoryEntry[] = [];

  constructor() {
    this.maxSize = this.localSnapshot.Settings.MaxHistoryListLength;
  }
...
export interface PlayerHistoryClass extends WithPlayerStore, WithLocalStore {}
